...
| LLM-induced rule set alone | 47.9 % | 0 |
| **student (12.8 K params, 49.8 KB)** | **94.1 %** | **0** |
...
Per family, under mutation (retrained `student_v7`): fading **100 %**, reactive 98.9 %,
barrage 98.1 %, congestion 96.9 %, node_loss 96.4 %, hidden_term 92.2 %, spot 88.6 %,
sweep **88.0 %** (up from 78.7 %). **Zero false positives acted on, across all 629.**
